#!/usr/bin/env python3
"""
Debug script to test entity updates for Proxmox VE integration.
"""
...
class MockCoordinator:
    ...
    async def async_request_refresh(self):
        ...
        for listener in self._listeners:
            try:
                listener()
                _LOGGER.debug("Successfully notified listener")
...
async def test_entity_updates():
    """Test the entity update functionality."""
    
    _LOGGER.info("=== STARTING ENTITY UPDATE TEST ===")
    ...
    coordinator.data["node_load_data"]["pve-0001"]["loadavg_1min"] = 2.5
    ...
    _LOGGER.info("=== ENTITY UPDATE TEST COMPLETED ===")
