#!/usr/bin/env python3
"""
Test script to check entity notification issues in Home Assistant.
"""
...
async def test_entity_notification():
    """Test entity notification functionality."""
    
    _LOGGER.info("=== STARTING ENTITY NOTIFICATION TEST ===")
    ...
    _LOGGER.info("=== ENTITY NOTIFICATION TEST COMPLETED ===")

if __name__ == "__main__":
    asyncio.run(test_entity_notification()) 