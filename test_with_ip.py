#!/usr/bin/env python3
"""Test script using IP address directly."""
...
def test_proxmox_with_ip():
    """Test Proxmox API using IP address directly."""
    ...
    host = "192.168.50.8:8006"  # IP address from nslookup
